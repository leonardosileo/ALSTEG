...
import it.sileo.associazionelucana.utils.VolleyService
 ...
 * [StoryFragment.OnFragmentInteractionListener] interface
...
class StoryFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        textStory = view.findViewById<TextView>(R.id.tv_home)
        val queue = Volley.newRequestQueue(activity)
        val url = getString(R.string.url) + param1 + getString(R.string.page)
        // Request a string response from the provided URL.
        val jsonObjectRequest = JsonObjectRequest(Request.Method.GET, url, null,
                Response.Listener<JSONObject> { response ->
                    textStory?.text = "%s".format(response.getString("text"))
